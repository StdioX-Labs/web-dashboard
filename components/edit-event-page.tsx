...
const mockEventData: { [key: number]: any } = {
  1: {
    ...
    saleEndTime: "17:00",
    ticketTypes: [
      { id: "1", name: "VIP Pass", price: "5000", quantity: "100", description: "Backstage access included", saleStartDate: undefined, saleEndDate: undefined },
      { id: "2", name: "General Admission", price: "2000", quantity: "300", description: "", saleStartDate: undefined, saleEndDate: undefined },
    ],
  },
  2: {
    ...
    saleEndTime: "",
    ticketTypes: [
      { id: "1", name: "Conference Pass", price: "3500", quantity: "250", description: "", saleStartDate: undefined, saleEndDate: undefined },
      { id: "2", name: "Workshop Bundle", price: "5000", quantity: "100", description: "Access to all workshops", saleStartDate: undefined, saleEndDate: undefined },
    ],
  },
  5: {
    ...
    saleEndTime: "",
    ticketTypes: [
      { id: "1", name: "Premium Seating", price: "3500", quantity: "80", description: "Front row seats", saleStartDate: undefined, saleEndDate: undefined },
      { id: "2", name: "Standard Entry", price: "2000", quantity: "120", description: "", saleStartDate: undefined, saleEndDate: undefined },
    ],
  },
  6: {
    ...
    saleEndTime: "",
    ticketTypes: [
      { id: "1", name: "VIP Experience", price: "2500", quantity: "100", description: "Meet and greet with comedians", saleStartDate: undefined, saleEndDate: undefined },
      { id: "2", name: "General Admission", price: "1500", quantity: "200", description: "", saleStartDate: undefined, saleEndDate: undefined },
    ],
  },
}
...
export default function EditEventPage({ eventId = 1 }: { eventId?: number }) {
  ...
  useEffect(() => {
    ...
    if (eventData) {
      ...
      if (eventData.saleStartDate && eventData.saleStartTime) {
        const saleStart = new Date(`${eventData.saleStartDate}T${eventData.saleStartTime}`)
        setSaleStartDateTime(saleStart)
      }

      // Parse sale end date/time
      if (eventData.saleEndDate && eventData.saleEndTime) {
        const saleEnd = new Date(`${eventData.saleEndDate}T${eventData.saleEndTime}`)
        setSaleEndDateTime(saleEnd)
      }
